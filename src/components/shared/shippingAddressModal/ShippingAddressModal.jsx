...
import { Modal, Card, Badge, Button, Form, InputGroup, Spinner } from "react-bootstrap";
...
const MAX_ACTIVE = 3;
function ShippingAddressModal({ showAddresses, onHide, activeAddresses, inactiveAddresses, selectedAddress,
    selectedId,
    search,
    onSearchChange,
    ...
    handleDesactivate,
    handleActivate,
    handleConfirmSelection, loadingAddresses }) {
        ...
        <>
            ...
            <Modal show={showAddresses} onHide={onHide} size="lg" centered scrollable>
                <Modal.Header closeButton>
                    <Modal.Title className="fw-bold" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                        ...
                        <>
                            ...
                            < div className="mb-4">
                                <div className="d-flex align-items-center justify-content-between mb-3">
                                    ...
                                    <Badge bg={activeAddresses.length >= MAX_ACTIVE ? "warning" : "secondary"} text={activeAddresses.length >= MAX_ACTIVE ? "dark" : undefined}>
                                ...
                                {activeAddresses.length === 0 ? (
                                    <Card className="border-dashed text-center py-4">
                                        <Card.Body>
                                            <p className="text-secondary small mb-0">No tenés direcciones activas. Activá una desde la lista de abajo.</p>
                                        </Card.Body>
                                    </Card>
                                ) : (
                                                    ...
                                                    <Card.Body className="p-3">
                                                        <div className="d-flex align-items-start gap-3">
                                                            ...
                                                            <div className="flex-grow-1" style={{ minWidth: 0 }}>
                                                                ...
                                                                <div className="small text-secondary">{a.city}, {a.province} — CP {a.zipCode}</div>
                                                                <div className="small text-secondary">Tel: {a.phone}</div>
                                                            </div>
                                                            <div className="d-flex flex-column gap-2">
                                                                <Button
                                                                    size="sm"
                                                                ...
                                                                <Button
                                                                    ...
                                                                    onClick={(e) => { e.stopPropagation(); handleDesactivate(a.id); }}
                                        ...
                                        {filteredInactiveAddresses.map((a) => {
                                            ...
                                            return (
                                                <Card
                                                    key={a.id}
                                                    className="border"
                                                    style={{ opacity: 0.7, background: "var(--bs-light, #f8f9fa)" }}
                                                >
                                                    <Card.Body className="p-3">
                                                        <div className="d-flex align-items-start gap-3">
                                                            <div className="flex-grow-1" style={{ minWidth: 0 }}>
                                                                <div className="d-flex align-items-center gap-2 mb-1 flex-wrap">
                                                                    <span className="fw-bold text-secondary">○ {a.id}</span>
                                                                    <Badge bg="secondary" pill>Inactiva</Badge>
                                                                </div>
                                                                <div className="small text-secondary">{a.fullName}</div>
                                                                <div className="small text-secondary">{a.address}</div>
                                                                <div className="small text-secondary">{a.city}, {a.province} — CP {a.zipCode}</div>
                                                            </div>
                                                            <Button
                                                                ...
                                                                title={limitReached ? `Máximo ${MAX_ACTIVE} direcciones activas` : "Activar dirección"}
                ...
                <Modal.Footer className="d-flex justify-content-between">
                    <div className="d-flex gap-2">
                        <Button variant="light" onClick={onHide}>Cerrar</Button>
                        <Button variant="primary" onClick={handleConfirmSelection} disabled={!selectedId}>
