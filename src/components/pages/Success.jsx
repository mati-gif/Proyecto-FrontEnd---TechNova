...
function Success() {
  ...
  return (
    <Container className="py-5 text-center" style={{ maxWidth: 640 }}>
      ...
      <Card
        className="border text-start mx-auto mb-4"
        style={{ maxWidth: 420 }}
      >
        <Card.Body className="p-4">
          <div className="d-flex align-items-center gap-3 mb-3">
            ...
            <div>
              <div
                className="text-uppercase text-secondary small fw-semibold"
                style={{ fontSize: 11 }}
              >
                Número de orden:
              </div>
          ...
          <div className="text-secondary small">
            ¡Tu pedido ya está siendo preparado! Te llegará en las próximas 72hs
            hábiles.
          </div>
        </Card.Body>
      </Card>
