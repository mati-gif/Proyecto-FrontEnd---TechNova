...
function Payment() {
  ...
  const validateErrors = () => {
    ...
    if (form.expiry.trim() === "") {
      ...
      if (form.cvc.trim() === "") {
        newErrors.cvc =
          "Los tres numeros detras de la tarjeta no pueden estar vacíos";
  ...
  const handleCreateOrder = async (datosParaEnviar) => {
    ...
    try {
      ...
      navigate(`/success?order=${data.order.orderCode}&id=${data.order.id}`);
    } catch (error) {
      console.log(error);
    ...
    <Container className="py-4 py-lg-5">
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <Button
          ...
          to="/checkout"
          variant="link"
          className="text-secondary text-decoration-none ps-0 mb-2 d-inline-flex align-items-center gap-1"
        >
              ...
              <Card className="border mb-4">
                <Card.Body className="p-4">
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, #2b56f5 0%, #7d3df0 50%, #f57b1f 100%)",
                      color: "#fff",
                      borderRadius: "1rem",
                      padding: "1.5rem",
